            ...
            <div id="content">
              ...
              <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Create Election</h1>
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="card mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">ELection Form</h6>
                                </div>
                                <div class="card-body">
                            ...
                            <input type="hidden" name="method" value="save">
                                ...
                                <div class="col-sm-6 mb-3 mb-sm-0 ">
                                 <label ><font size='2'>Election Name</font></label>
                                    <input type="text" class="form-control form-control-user"  placeholder="Election Name" id="election_name" name="election_name" 
                                        required>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <label ><font size='2'>&nbsp; &nbsp; Nomination Start Date</font></label>
                                        ...
                                        placeholder="Election Start Date"   required>
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        placeholder="Election End Date"   required>
                                           </div>
                                ...
                                <textarea class="form-control form-control-user" id="description" name="description"
                                        placeholder="Eligibility" rows="0.5" cols="2" required></textarea>
