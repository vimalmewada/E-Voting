...
<% AdminDto adminDto  = (session.getAttribute("currentSessionUser"))!= null ? (AdminDto)session.getAttribute("currentSessionUser") : null; 
			...
			Voter voter=request.getAttribute("voterdto")!=null?(Voter)request.getAttribute("voterdto"):null;
			%>
            ...
            <div id="content">
              ...
              <!-- Begin Page Content -->
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-1 text-gray-800">Update Voter </h1>
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="card mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Update Voter Details</h6>
                                </div>
                                <div class="card-body">
                                
                                	<form class="user" action="Voterregistration"  method="post">
                                	<input type="hidden" name="method" value="updateVoter">
                                	<input type="hidden" value=<%=voter.getVoter_id() %> name="voter_id">
