					...
					<div class="row">
						...
						<div class="col-lg-6">
							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									<p class="text-gray-200 p-4 bg-gradient-success m-0">Admin ID: <%=adminDto.getAdmin_id() %><br>
									 Name: <%=adminDto.getName() %><br>
								 	 Email : <%=adminDto.getEmail() %><br>
									 Mobile Number: <%=adminDto.getMobile() %></p>
								</div>
							</div>
						</div>
					</div>
